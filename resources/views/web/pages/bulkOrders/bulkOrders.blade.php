            ...
            <form>
                <div class="page-details">
                    <div class="page-heade">
                        <h2>طلبات الجملة والكميات</h2>
                        <span>تقدم فرنتشر هب أسعار خاصة لطلبات الجملة والكميات الكبيرة ، سجل بياناتك وسنقوم بالتواصل معك في
                        أقرب وقت ممكن للإجابة على جميع استفساراتك</span>
                    </div>
                    <div class="page-from">
                        <div class="form">
                            @for ($i = 0; $i < 3; $i++) <div class="pageFormInput">
                            ...
                            <div class="pageFormInput">
                                ...
                                <div class="inputContainer">
                                    ...
                                    <select>
                                        <option value="0">اختار المدينة التابع ليها</option>
                                        <option value="0">اختار المدينة التابع ليها</option>
                                        <option value="0">اختار المدينة التابع ليها</option>
                                    </select>
                                </div>
                            ...
                            <div class="products">
                                ...
                                <div class="addProduct">
                                    <div class="addProductBtn" id="addProductBtn">اضف منتج اخر</div>
                                </div>
                            </div>
                        </div>
                    </div>
