            ...
            <div class="account-wrapper">
                ...
                <div class="account-body">
                    ...
                    <a href="{{route('web.profile')}}">
                        <div class="account-item account-details {{ request()->is('en/profile') | request()->is('profile') ? 'active' : '' }}">
                            <div class="icon dashboard-icons">
                    ...
                    <a href="{{route('web.addresses')}}">
                        <div class="account-item shopping-address {{ request()->is('en/addresses') | request()->is('addresses') ? 'active' : '' }}">
                            <div class="icon dashboard-icons">
                                <svg width="18" height="19" viewBox="0 0 18 19"  xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="{{route('web.download')}}">
                        <div class="account-item downloads {{ request()->is('e/download') | request()->is('download') ? 'active' : '' }}">
                            <div class="icon dashboard-icons">
                                <svg width="18" height="19" viewBox="0 0 18 19"  xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="{{route('web.orders')}}">
                        <div class="account-item orders {{ request()->is('en/orders') | request()->is('orders') ? 'active' : '' }}">
                            <div class="icon dashboard-icons">
                                <svg width="18" height="19" viewBox="0 0 18 19"  xmlns="http://www.w3.org/2000/svg">
