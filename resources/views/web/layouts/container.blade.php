            ...
            <div class="sec-header">
                <div class="container">
                    <ul class='categories-shop'>
                        @foreach ($categoriesMain as $index => $row) 
                            <li class='categories-item' onmouseover="showContent('content{{$index + 1}}-1')" onmouseout="hideContent('content{{$index + 1}}-1')" style="font-size:15px">{{ $row->title }}</li>
                        @endforeach
                    </ul>
                </div>
                <div class="box-categories-shop">
                    @foreach ($categoriesMain as $index => $row) 
                        ...
                        <div id="content{{$index + 1}}-1" class="hidden-content tob-header" onmouseover="showContent('content{{$index + 1}}-1')" onmouseout="hideContent('content{{$index + 1}}-1')">
                            <div class="main">
                                <div class="main-items main-items-tags " style="height:200px">
                                    <div class="tags">
                                        <ul class='main-cat'>
                                            @foreach ($row->models as $model)
                                                <li class='cat-item' style="list-style:circle;"><a href="{{ route('web.shop', $model->slug) }}" Style="color:black;"> {{$model->details->title}}</a></li>
                                            @endforeach
   
                                        </ul>
                                    </div>
                                    <span class='view'><a href="{{ route('web.shop', $row->slug) }}" Style="color:#fd9636">{{__('web.view_all')}}</a></span>
                                </div>
                            ...
                            <div class="cart-total">
                                <div class="total-row">
                                    ...
                                    <div class="">
                                        ...
                                        <span 
                                            style="color: #000"
                                            class="font-md-bold ">{{ $currency->symbol }}
                                        </span>
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 width-25 mb-30">
                        ...
                        <div class="font-md mb-20 color-gray-900"><strong
                                class="font-md-bold">{{ __('web.address') }}</strong> {{ __('web.address_details') }}
                        </div>
                        {{-- <div class="font-md mb-20 color-gray-900"><strong class="font-md-bold">{{ __('web.address') }}</strong> <a href="https://www.google.com/search?q=Furniture+Hub+Alex+Branch+%7C+%D9%81%D8%B1%D9%86%D8%AA%D8%B4%D8%B1+%D9%87%D8%A8+%D9%81%D8%B1%D8%B9+%D8%A7%D9%84%D8%A7%D8%B3%D9%83%D9%86%D8%AF%D8%B1%D9%8A%D8%A9&stick=H4sIAAAAAAAA_-NgU1I1qDA0STNNSTI1NLNMtTRIskyxMqiwNDRKSTEwMDBMNTMwNU80WcTq6VZalJdZUlqUquBRmqTgmJNaoeBUlJiXnKFQo3Cz8cbGm203Vt3YcmOjws32GyvAIjd2KtxYfrPlxvIbm282A6XXAxV13VgJAFK9iAx1AAAA&hl=ar&mat=CQzAMtu0yju-ElcB7PxHsZBNHBuTYKtWBkBbXDIgGHLqPYohSVzejJo8u9TftpYAKIffiB2CRTLb3WZWFFzR4zVGDC5i0FVjoHPJrFFEFu4vJVPF2iexmXy6CU2-Ck8XLnk&authuser=0" target="_blank">{{ __('web.showroom') }}</a> </div> --}}
                        <div class="font-md mb-20 color-gray-900"><strong
                                class="font-md-bold">{{ __('web.phone') }}</strong> <a href="tel:{{ settings('phone') }}"
                                target="_blank">{{ settings('phone') }}</a></div>
                        <div class="font-md mb-20 color-gray-900"><strong
                                class="font-md-bold">{{ __('web.email') }}</strong>
                            {{ settings('email') }}</div>
                        <div class="font-md mb-20 color-gray-900"><strong
                                class="font-md-bold">{{ __('web.hours') }}</strong> {{ settings('work_time') }}
                            {{ __('web.hour') }}</div>
                        <div class="mt-30">
                            <a href="{{ settings('facebook') }}" target="_blank"><img
                                    src="{{ asset('public/storage/icons/facebook.webp') }}" loading="lazy"
                                    alt="facebook"></a>
                            <a href="https://wa.me/201060552252" target="_blank"><img
                                    src="{{ asset('public/storage/icons/whatsApp.webp') }}" loading="lazy"
                                    alt="whatsapp"></a>
                            <a href="https://t.me/+201060552252" target="_blank"><img
                                    src="{{ asset('public/storage/icons/Telegram.webp') }}" loading="lazy"
                                    alt="telegram"></a>
                            <a href="https://m.me/furniturehubapp" target="_blank"><img
                                    src="{{ asset('public/storage/icons/messenger.webp') }}" loading="lazy"
                                    alt="messenger"></a>
                            <a href="{{ settings('instagram') }}" target="_blank"><img
                                    src="{{ asset('public/storage/icons/instagram.png') }}" loading="lazy"
                                    alt="instagram"></a>
                            <a href="{{ settings('twitter') }}" target="_blank"><img
                                    src="{{ asset('public/storage/icons/x.webp') }}" loading="lazy" alt="x"></a>
                            <a href="{{ settings('linkedin') }}" target="_blank"><img
                                    src="{{ asset('public/storage/icons/linkedin.webp') }}" loading="lazy"
                                    alt="linkedin"></a>
                            <a href="https://www.google.com/search?q=Furniture+Hub&stick=H4sIAAAAAAAA_-NgU1I1qDA0SbNMNU4yMTC2SDYwTE2zMqiwAALDFAtDAxOLFDMLs5RFrLxupUV5mSWlRakKHqVJAAqoV-w5AAAA&hl=ar&mat=CZ6vUxz-ZahTElcB7PxHsRPBLfJTdfs_q_QiI2Cakgjh5B74HghiXzkSaMy3fIx_JLCTQB41-3BTPBDQx7jrMiIUSGXTsX2wTS-aQCCvC1krwoPdmmxQL7_CgMpE3p1J5Do&authuser=0"
                                target="_blank"><img src="{{ asset('public/storage/icons/location.png') }}"
                        ...
                        <div>
                            ...
                            <div class="mt-20">
                                <a class="mr-10" href="{{ settings('apple') }}" target="_blank">
                                    <img src="{{ url('') }}/public/assets/web/ASSETS_En/imgs/template/appstore.png" loading="lazy" alt="Furniture Hub">
                                </a>
                                <a href="{{ settings('google') }}" target="_blank">
                                    <img src="{{ url('') }}/public/assets/web/ASSETS_En/imgs/template/google-play.png" loading="lazy" alt="Furniture Hub">
                                </a>
                            </div>
                            <p class="font-md color-gray-900 mt-20 mb-10">{{ __('web.secured_payment_gateways') }}</p><img
                                src="{{ url('') }}/public/assets/web/ASSETS_En/imgs/template/payment-method.png"
