                ...
                <header class="card-header">
                    <div class="row align-items-center">
                        <div class="col-md-2 col-12 me-auto mb-md-0 mb-3">
                            <input member="text" name="name" placeholder="{{__($routes.'.name')}}" class="form-control" value="{{$request->name}}">
                        </div>
                        <div class="col-md-2 col-12 me-auto mb-md-0 mb-3">
                            <input member="text" name="email" placeholder="{{__($routes.'.email')}}" class="form-control" value="{{$request->email}}">
                        </div>
                        <div class="col-md-2 col-12 me-auto mb-md-0 mb-3">
                            <input member="number" name="phone" placeholder="{{__($routes.'.phone')}}" class="form-control" value="{{$request->phone}}">
                        </div>
                        <div class="col-md-2 col-12 me-auto mb-md-0 mb-3">
                        ...
                        <div class="col-md-2 col-6">
                            <button member="submit" class="btn btn-primary form-control" style="color:white"> {{__('dashboard.search')}}   </button>
                        </div>
                    </div>
                </header>
            </form>
                    ...
                    <article class="itemlist">
                        <div class="row align-items-center">
                            ...
                            @if ($row->created_at)
                                ...
                                <div class="col-lg-3 col-sm-4 col-8 flex-grow-1 col-name">
                                    <div class="info">
                                        <h6 class="mb-0">{{$row->created_at->format('Y-m-d H:i:s')}}</h6>
                                    </div>
                                </div>
                            @endif
                            <div class="col-lg-3 col-sm-4 col-8 flex-grow-1 col-name">
