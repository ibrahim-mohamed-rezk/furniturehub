            ...
            <div class="detail-gallery">
                <div class="product-image-slider-2">
                    <figure class="border-radius-10">
                        <img src="{{ url('') }}/assets/web/assets/imgs/page/product/img-gallery-1.jpg" alt="product image">
                    </figure>
                    <figure class="border-radius-10"><img
                                src="{{ url('') }}/assets/web/assets/imgs/page/product/img-gallery-2.jpg"
                                alt="product image"></figure>
                    <figure class="border-radius-10"><img
                                src="{{ url('') }}/assets/web/assets/imgs/page/product/img-gallery-3.jpg"
                                alt="product image"></figure>
                    <figure class="border-radius-10"><img
                                src="{{ url('') }}/assets/web/assets/imgs/page/product/img-gallery-4.jpg"
                                alt="product image"></figure>
                    <figure class="border-radius-10"><img
                                src="{{ url('') }}/assets/web/assets/imgs/page/product/img-gallery-5.jpg"
                                alt="product image"></figure>
                    <figure class="border-radius-10"><img
                                src="{{ url('') }}/assets/web/assets/imgs/page/product/img-gallery-6.jpg"
                                alt="product image"></figure>
                    <figure class="border-radius-10"><img
                                src="{{ url('') }}/assets/web/assets/imgs/page/product/img-gallery-7.jpg"
                                alt="product image"></figure>
                </div>
            </div>
            <div class="slider-nav-thumbnails-2">
                <div>
                    <div class="item-thumb"><img
                                src="{{ url('') }}/assets/web/assets/imgs/page/product/img-gallery-1.jpg"
...
<div class="col-lg-6">
    <div class="product-info">
        ...
        <div class="info-by"><span class="bytext color-gray-500 font-xs font-medium">by</span><a
            ...
            <div class="rating d-inline-block"><img src="{{ url('') }}/assets/web/assets/imgs/template/icons/star.svg"
                                                    alt="Ecom"><img src="{{ url('') }}/assets/web/assets/imgs/template/icons/star.svg"
                                                                    alt="Ecom"><img src="{{ url('') }}/assets/web/assets/imgs/template/icons/star.svg"
                                                                                    alt="Ecom"><img src="{{ url('') }}/assets/web/assets/imgs/template/icons/star.svg"
                                                                                                    alt="Ecom"><img src="{{ url('') }}/assets/web/assets/imgs/template/icons/star.svg"
        ...
        <div class="box-product-color mt-10">
            ...
            <ul class="list-colors">
                <li class="disabled"><img src="{{ url('') }}/assets/web/assets/imgs/page/product/img-gallery-1.jpg"
                                          alt="Ecom" title="Pink"></li>
                <li><img src="{{ url('') }}/assets/web/assets/imgs/page/product/img-gallery-2.jpg" alt="Ecom"
                         title="Gold"></li>
                <li><img src="{{ url('') }}/assets/web/assets/imgs/page/product/img-gallery-3.jpg" alt="Ecom"
                         title="Pink Gold"></li>
                <li><img src="{{ url('') }}/assets/web/assets/imgs/page/product/img-gallery-4.jpg" alt="Ecom"
                         title="Silver"></li>
                <li class="active"><img src="{{ url('') }}/assets/web/assets/imgs/page/product/img-gallery-5.jpg"
                                        alt="Ecom" title="Pink Gold"></li>
                <li class="disabled"><img src="{{ url('') }}/assets/web/assets/imgs/page/product/img-gallery-6.jpg"
                                          alt="Ecom" title="Black"></li>
                <li class="disabled"><img src="{{ url('') }}/assets/web/assets/imgs/page/product/img-gallery-7.jpg"
                                          alt="Ecom" title="Red">
                </li>
            </ul>
        </div>
