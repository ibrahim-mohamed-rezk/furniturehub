                ...
                <header class="card-header">
                    <div class="row align-items-center">
                        <div class="col-md-3 col-12 me-auto mb-md-0 mb-3">
                            <input type="text" name="title" placeholder="{{ __($routes . '.request') }}"
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th>#ID</th>
                                <th scope="col">{{ __('faqs.request') }}</th>
                                <th scope="col">{{ __('faqs.created_at') }}</th>
                                <th class="text-end" scope="col"> {{ __('faqs.Action') }}</th>
                            </tr>
                        </thead>
                        <tbody>
