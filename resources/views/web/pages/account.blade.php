        ...
        <div class="account-container">
            <div class="account-wrapper">
                <div class="account-header">
                    <div class="header-title">{{ __('web.account') }}</div>
                ...
                <div class="account-body">
                    <a href="{{ route('account.index') }}">
                        <div
                            ...
                            <div class="item-title">{{ __('dashboard.dashboard') }}</div>
                        </div>
                    </a>
                    ...
                    <a href="{{ route('web.profile') }}">
                        <div
                            ...
                            <div class="item-title">{{ __('web.account_details') }}</div>
                        </div>
                    </a>
                    <div class="separator"></div>
                    <a href="{{ route('web.addresses') }}">
                        <div
                            ...
                            <div class="item-title">{{ __('web.addresses') }}</div>
                        </div>
                    </a>
                    <div class="separator"></div>
                    {{-- <a href="{{ route('web.download') }}">
                        <div
                            ...
                            <div class="item-title">{{ __('web.downloads') }}</div>
                        </div>
                    </a> --}}
                    <div class="separator"></div>
                    <a href="{{ route('web.orders') }}">
                        <div
                            ...
                            <div class="item-title">{{ __('web.orders') }}</div>
                        </div>
                    </a>
                    <div class="separator"></div>
                    <a href="{{route('web.logout')}}">
                        <div class="account-item logout">
                            ...
                            <div class="item-title">{{ __('dashboard.logout') }} </div>
                        </div>
                    </a>
                </div>
            </div>
