                ...
                <div class="box-category-left">
                    <div class="box-menu-category bg-white">
                        ...
                        <ul class="list-nav-arrow">
                            <li><a href="shop-grid.html">Monitors & Projects</a></li>
                            <li><a href="shop-grid.html">Screen Protectors</a></li>
                            <li><a href="shop-grid.html">Computers & Tablets</a></li>
                            <li><a href="shop-grid.html">Data Storage</a></li>
                            <li><a href="shop-grid.html">Laptop Accessories</a></li>
                            <li><a href="shop-grid.html">Networking Products</a></li>
                            <li><a href="shop-grid.html">Tablet Accessories</a></li>
                            <li><a href="shop-grid.html">Camera Privacy Covers</a></li>
                            <li><a href="shop-grid.html">Chargers & Adapters</a></li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="card-grid-inner">
                                    <div class="tools">
                                        <a class="btn btn-trend btn-tooltip mb-10" href="#"
                                            ...
                                            href="shop-wishlist.html" aria-label="Add To Wishlist"></a>
                                        <a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.html"
                                    ...
                                    <div class="image-box"><span class="label bg-brand-2">-17%</span>
                                        <a href="">
                                            <img src="{{ url('') }}/assets/web/assets/imgs/page/homepage1/imgsp7.png"
                                                alt="Ecom">
                                        </a>
                                    </div>
                                    <div class="info-right">
                                        <span class="font-xs color-gray-500">Apple</span><br>
                                        <a class="color-brand-3 font-sm-bold"
                                            href="">Wyze
                                            Cam v3 1080p
                                            HD Indoor/Outdoor</a>
                                        <div class="rating">
                                            <img src="{{ url('') }}/assets/web/assets/imgs/template/icons/star.svg"
                                                alt="Ecom">
                                            <img src="{{ url('') }}/assets/web/assets/imgs/template/icons/star.svg"
                                                alt="Ecom">
                                            <img src="{{ url('') }}/assets/web/assets/imgs/template/icons/star.svg"
                            ...
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="image-box"><span class="label bg-danger">Hot</span><a
                                            href=""><img
                                                src="{{ url('') }}/assets/web/assets/imgs/page/homepage1/imgsp3.png"
                                                alt="Ecom"></a>
                                    </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="image-box"><span class="label bg-info">Deal</span><a
                                            href=""><img
                                                src="{{ url('') }}/assets/web/assets/imgs/page/homepage1/imgsp6.png"
                                                alt="Ecom"></a>
                                    </div>
                                    <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                            class="color-brand-3 font-sm-bold"
                                            href="">Universal Balance
                                            Hoverboard Electric Scooter</a>
                                        <div class="rating"><img
                                                src="{{ url('') }}/assets/web/assets/imgs/template/icons/star.svg"
                                                alt="Ecom"><img
                                                src="{{ url('') }}/assets/web/assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="image-box"><span class="label bg-danger">Hot</span><a
                                            href=""><img
                                                src="{{ url('') }}/assets/web/assets/imgs/page/homepage1/imgsp5.png"
                                                alt="Ecom"></a>
                                    </div>
                                    <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                            class="color-brand-3 font-sm-bold"
