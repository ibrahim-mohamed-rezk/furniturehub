...
@section('container_content')
    ...
    <main class="main " style="overflow: hidden">
                    ...
                    <div class="cart-total">
                        <div class="total-row">
                            ...
                            <div class="">
                                ...
                                <span style="color: #000" class="font-md-bold ">L.E
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="continu-shopping"><a
                                    href="{{ route('web.offers') }}">{{ __('web.or_continue_shopping') }}</a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        @include('web.component.container.features', ['footer_cards' => $footer_cards])
            ...
            <div class="footer-content">
                <div class="footer-top">
                    <div class="footer-subscribe">
                        <div class="subscribe-text">
                            <h4 class="">{{ __('web.get_a_surprise_discount') }}</h4>
                            <span class="">{{ __('web.join_our_email_subscription_now') }}</span>
                        </div>
                ...
                <div class="footer-body">
                    <div class="footer-aboout-us">
                        <h4>{{ __('web.about_us') }} <span></span></h4>
                        <p>{{ __('web.shop_now_footer') }}</p>
                        <div class="about-email">
                            <i class="fas fa-envelope"></i>
                            <span><a href="mail:info@furniturehubapp.com"
                                     target="_blank">info@furniturehubapp.com</a></span>
                        </div>
                        <div class="about-phone">
                            <i class="fas fa-phone"></i>
                            <span><a href="tel:01060552252" target="_blank">+201060552252</a></span>
                        </div>
                        <div class="about-phone">
                            <i class="fas fa-map-marker-alt"></i>
                            <span><a href="tel:01060552252" target="_blank">Egypt, Damietta, New Damietta</a></span>
                        </div>
                    </div>
                        ...
                        <div class="footer-logo">
                            <div class="footer-logo-img">
                                @if (getCurrentLocale() == 'en')
                                    <img src="{{ url('') }}/storage/assets/footer/footer-logo.png"
                                         alt="Furniture Hub">
                                @else
                                    <img src="{{ url('') }}/storage/assets/footer/footer-logo.png"
                                         alt="Furniture Hub">
                            ...
                            <div class="footer-follow">
                                ...
                                <div class="follow-icons">
                                    ...
                                    <a href="https://www.pinterest.com/furniturehub_eg/" target="_blank"><i
                        ...
                        <div class="download-image">
                            <div class="">
                                <a href="{{ settings('google') }}" target="_blank">
                                    <img src="{{ asset('storage/assets/footer/google-play.png') }}"
                                         alt="Furniture Hub" />
                                </a>
                            </div>
                            <div class="">
                                <a href="{{ settings('apple') }}" target="_blank">
                                    <img src="{{ asset('storage/assets/footer/app-store.png') }}" alt="Furniture Hub" />
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="footer-account">
                        <h4>{{ __('web.main_pages') }} <span></span></h4>
                        <ul>
                            <li><a href="{{ route('web.blog') }}" target="_blank"
                                   title="{{ __('web.read_our_latest_blog') }}">{{ __('web.blog') }}</a></li>
                            <li><a href="{{ route('web.shop') }}" target="_blank"
                                   title="{{ __('web.shop_our_products') }}">{{ __('web.products') }}</a></li>
                            <li><a href="{{ route('web.contact') }}" target="_blank"
                                   title="{{ __('web.contact_us_for_inquiries') }}">{{ __('web.contact_us') }}</a></li>
                            <li><a href="{{ route('web.privacy') }}" target="_blank"
                                   title="{{ __('web.read_our_return_policy') }}">{{ __('web.return_policy') }}</a></li>
                            <li><a href="{{ route('web.faq') }}" target="_blank"
                                   title="{{ __('web.find_answers_to_frequently_asked_questions') }}">{{ __('web.FAQs') }}</a>
                            </li>
                ...
                <div class="footer-bottom">
                    <div class="bottom-text">
                        <div>
                            {{ __('web.privacy_policy') }}
                        </div>
                        <div>
                            |</div>
                        <div>
                            {{ __('web.terms_conditions') }}
                        </div>
                    </div>
