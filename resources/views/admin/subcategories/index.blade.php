                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th>#ID</th>
                                <th scope="col">{{ __('subcategories.main_cat') }}</th>
                                <th scope="col">{{ __('subcategories.title') }}</th>
                                
                                <th class="text-end" scope="col"> {{ __('subcategories.Action') }}</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($categories as $key => $row)
                                <tr>
                                    <td>{{ $key +1 }}</td>
                                    <td><b>{{ $row->getTitleOfCategoryById($row->category_id) }}</b></td>
                                    <td><b>{{ $row->title }}</b></td>
