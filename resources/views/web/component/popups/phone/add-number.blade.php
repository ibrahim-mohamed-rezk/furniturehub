        ...
        <div class="popup-container">
            ...
            <form action="{{ route('web.update_phone') }}" method="POST" onsubmit="formAction(this)">
                ...
                <div class="input-container">
                    <div class="popup-input">
                        <div class="custom-dropdown">
                            ...
                            {{-- <div class="dropdown-content" id="dropdown">
                                <div class="dropdown-item" onclick="selectItem(this)" data-value="+20">
                                    <img src="{{url('/public/storage/assets/popups/eg.svg')}}" alt="eg-flag"/>
                                    <span>+20</span>
                                </div>
                                <div class="dropdown-item" onclick="selectItem(this)" data-value="+965">
                                    <img src="{{url('/public/storage/assets/popups/kw.svg')}}" alt="kw-flag"/>
                                    <span>+965</span>
                                </div>
                                <div class="dropdown-item" onclick="selectItem(this)" data-value="+971">
                                    <img src="{{url('/public/storage/assets/popups/ae.svg')}}" alt="ae-flag"/>
                                    <span>+971</span>
                                </div>
                                <div class="dropdown-item" onclick="selectItem(this)" data-value="+966">
                                    <img src="{{url('/public/storage/assets/popups/sa.svg')}}" alt="sa-flag"/>
                                    <span>+966</span>
                                </div>
                            </div> --}}
                        </div>
                    ...
                    <span class="popup-aleart">{{__('web.make_sure_to_enter_the_number_correctly_to_complete_the_purchase_process')}}</span>
                </div>
                <div class="popup-btn">
                    <button type="submit">{{__('web.submit')}}</button>
                </div>
            </form>
        </div>
    </div>
