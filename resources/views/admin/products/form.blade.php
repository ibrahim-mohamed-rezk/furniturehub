                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="seller_id"
                                        ...
                                        @foreach ($sellers as $row)
                                            <option
                                                {{ isset($product) ? ($product->seller_id == $row->id ? 'selected' : '') : '' }}
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="page_offer"
                                        class="form-control {{ $errors->has('page_offer') ? 'is-invalid' : '' }}"
                                        id="validationServer">
                                        <option value="">{{ __('products.select') }}</option>
                                        <option
                                            {{ isset($product) ? ($product->page_offer == 'no' ? 'selected' : '') : '' }}
                                            value="no">{{ __('web.no') }}</option>
                                        <option
                                            {{ isset($product) ? ($product->page_offer == 'yes' ? 'selected' : '') : '' }}
                                            value="yes">{{ __('web.yes') }}</option>
                                    </select>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <label for="validationServer">{{ __('products.type_product') }}</label>
                                    <select name="type_product"
                                        class="form-control {{ $errors->has('type_product') ? 'is-invalid' : '' }}"
                                        id="validationServer">
                                        <option value="">{{ __('products.select') }}</option>
                                        <option
                                            {{ isset($product) ? ($product->type == 'piece' ? 'selected' : '') : '' }}
                                            value="piece">{{ __('products.piece') }}</option>
                                        <option
                                            {{ isset($product) ? ($product->type == 'meter' ? 'selected' : '') : '' }}
                                            value="meter">{{ __('products.meter') }}</option>
                                    </select>
                                </div>
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="number" name="count"
                                        ...
                                        id="validationServer" placeholder="{{ __('products.count') }}"
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="number" name="cost"
                                        ...
                                        id="validationServer" placeholder="{{ __('products.cost') }}"
                                        value='{{ old('cost', $product->cost ?? '') }}'>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <label for="validationServer">{{ __('products.sku_code') }}</label>
                                    <input type="text" name="sku_code"
                                        class="form-control {{ $errors->has('sku_code') ? 'is-invalid' : '' }}"
                                        id="validationServer" placeholder="{{ __('products.sku_code') }}"
                                        value='{{ old('sku_code', $product->sku_code ?? '') }}'>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <label for="validationServer">{{ __('products.cost_discount') }}</label>
                                    <input type="text" name="cost_discount"
                                        class="form-control {{ $errors->has('cost_discount') ? 'is-invalid' : '' }}"
                                        id="validationServer" placeholder="{{ __('products.cost_discount') }}"
                                        value='{{ old('cost_discount', $product->cost_discount ?? '') }}'>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                @foreach (languages() as $key => $language)
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="text" name="name_{{ $language->local }}"
                                            ...
                                            placeholder="{{ __('products.name') }} {{ $language->name }}"
                                            value='{{ old("name_{$language->local}", $product[$language->local]->name ?? '') }}'>
                                    </div>
                                @endforeach
                                @foreach (languages() as $key => $language)
                                    <div class="col-md-6 mb-4">
                                ...
                                @foreach (languages() as $key => $language)
                                    <div class="col-md-6 mb-4">
                                        <label for="validationServer{{ $key }}">{{ __('products.material') }}
                                            {{ $language->name }}</label>
                                        <input type="text" name="material_{{ $language->local }}"
                                            class="form-control {{ $errors->has('material_' . $language->local) ? 'is-invalid' : '' }}"
                                            id="validationServer{{ $key }}"
                                            placeholder="{{ __('products.material') }} {{ $language->name }}"
                                            value='{{ old("material_{$language->local}", $product[$language->local]->material ?? '') }}'>
                                    </div>
                                @endforeach
                                @foreach (languages() as $key => $language)
                                    <div class="col-md-6 mb-4">
                                        <label for="validationServer{{ $key }}">{{ __('products.dimensions') }}
                                            {{ $language->name }}</label>
                                        <input type="text" name="dimensions_{{ $language->local }}"
                                            class="form-control {{ $errors->has('dimensions_' . $language->local) ? 'is-invalid' : '' }}"
                                            id="validationServer{{ $key }}"
                                            placeholder="{{ __('products.dimensions') }} {{ $language->name }}"
                                            value='{{ old("dimensions_{$language->local}", $product[$language->local]->dimensions ?? '') }}'>
                                    </div>
                                @endforeach
                                @foreach (languages() as $key => $language)
                                    <div class="col-md-6 mb-4">
                                        <label for="validationServer{{ $key }}">{{ __('products.color') }}
                                            {{ $language->name }}</label>
                                        <input type="text" name="color_{{ $language->local }}"
                                            class="form-control {{ $errors->has('color_' . $language->local) ? 'is-invalid' : '' }}"
                                            id="validationServer{{ $key }}"
                                            placeholder="{{ __('products.color') }} {{ $language->name }}"
                                            value='{{ old("color_{$language->local}", $product[$language->local]->color ?? '') }}'>
                                    </div>
                                @endforeach
                                @foreach (languages() as $key => $language)
                                    <div class="col-md-6 mb-4">
                                        <label for="validationServer{{ $key }}">{{ __('products.delivery') }}
                                            {{ $language->name }}</label>
                                        <input type="text" name="delivery_{{ $language->local }}"
                                            class="form-control {{ $errors->has('delivery_' . $language->local) ? 'is-invalid' : '' }}"
                                            id="validationServer{{ $key }}"
                                            placeholder="{{ __('products.delivery') }} {{ $language->name }}"
                                            value='{{ old("delivery_{$language->local}", $product[$language->local]->delivery ?? '') }}'>
                                    </div>
                                @endforeach
                                @foreach (languages() as $key => $language)
                                    <div class="col-md-6 mb-4">
                                        <label for="validationServer{{ $key }}">{{ __('products.made_in') }}
                                            {{ $language->name }}</label>
                                        <input type="text" name="made_in_{{ $language->local }}"
                                            class="form-control {{ $errors->has('made_in_' . $language->local) ? 'is-invalid' : '' }}"
                                            id="validationServer{{ $key }}"
                                            placeholder="{{ __('products.made_in') }} {{ $language->name }}"
                                            value='{{ old("made_in_{$language->local}", $product[$language->local]->made_in ?? '') }}'>
                                    </div>
                                @endforeach
                                @foreach (languages() as $key => $language)
                                    <!--<div class="col-md-6 mb-4">-->
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <label
                                            for="validationServer{{ $key }}">{{ __('products.meta_description') }}
                                            {{ $language->name }}</label>
                                        <textarea id="textarea{{$key+1}}"  name="meta_description_{{ $language->local }}"
                                            class="form-control {{ $errors->has('meta_description_' . $language->local) ? 'is-invalid' : '' }}"
                                            placeholder="{{ __('products.meta_description') }} {{ $language->name }}" rows="4"
                                            style="height: 48px;">{{ old("meta_description_{$language->local}", $product[$language->local]->meta_description ?? '') }}</textarea>
                                    </div>
                                @endforeach
                                @foreach (languages() as $key => $language)
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="text" name="keywords_{{ $language->local }}"
                                            ...
                                            id="validationServer{{ $key }}"
                                            placeholder="{{ __('products.keywords') }} {{ $language->name }}"
                                            value='{{ old("keywords_{$language->local}", $product[$language->local]->keywords ?? '') }}'>
                                    </div>
                                @endforeach
                                @foreach (languages() as $key => $language)
                                    <div class="col-md-6 mb-4">
                                        <label
                                            for="validationServer{{ $key }}">{{ __('products.description') }}
                                            {{ $language->name }}</label>
                                        <textarea id="textareasub{{$key+1}}" name="description_{{ $language->local }}"
                                            class="form-control {{ $errors->has('description_' . $language->local) ? 'is-invalid' : '' }}"
                                            placeholder="{{ __('products.description') }} {{ $language->name }}" rows="4" style="height: 48px;">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    @if ($product ?? '' && $product->id)
                                        <img src="{{ asset($product->image) }}"
                                            style="margin-top: 15px;height: 5pc;width: 15pc;">
                                    @endif
                                </div>
                                        ...
                                        @foreach ($photos as $key => $photo)
                                            <div class="row pricing-list-item border-item mb-4"
                                                ...
                                                <div class="form-group col-lg-2" style="font-size: 30px;margin-top:20px;">
                                                    <i class="fas fa-times-circle" data-id="{{ $photo->id }}"
                                                        onclick="reomvephoto(this)"></i>
                                                </div>
                                            </div>
                                        @endforeach
                                    @endif
                                ...
                                <div class="col-md-12 mb-4">
                                    <a style="cursor: pointer;" data-id="{{ $count_photos }}" onclick="addphoto(this)"
                                        class="btn_1 gray "><i
                                            class="fa fa-fw fa-plus-circle"></i>{{ __('products.addphoto') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row">
                                            ...
                                            <div class="row pricing-list-item border-item mb-4"
                                                ...
                                                @foreach (languages() as $language)
                                                    <div class="col-md-5 mb-4">
                                                        ...
                                                        <input type="text"
                                                            name="items[{{ $key }}][name_{{ $language->local }}]"
                                                            class="form-control " id="validationServer"
                                                            placeholder="{{ __('products.name') . ' ' . $language->local }}"
                                                            value="{{ $item->descriptions($language->id)->name }}">
                                                    </div>
                                                @endforeach
                                                <div class="form-group col-lg-2" style="font-size: 30px;margin-top:20px;">
                                ...
                                <div class="col-md-12 mb-4">
                                    <a style="cursor: pointer;" data-id="{{ $count_items }}" onclick="additem(this)"
                                        class="btn_1 gray "><i
                                            class="fa fa-fw fa-plus-circle"></i>{{ __('products.additem') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row">
                                            ...
                                            <div class="row pricing-list-item border-item mb-4"
                                                ...
                                                @foreach (languages() as $language)
                                                    <div class="col-md-5 mb-4">
                                                        <label for="validationServer">{{ __('products.key') }}</label>
                                                        <input type="text"
                                                            name="sections[{{ $key }}][key_{{ $language->local }}]"
                                                            class="form-control " id="validationServer"
                                                            placeholder="{{ __('products.key') . ' ' . $language->local }}"
                                                            value="{{ $section->descriptions($language->id)->key }}">
                                                    </div>
                                                @endforeach
                                                <div class="form-group col-lg-2" style="font-size: 30px;margin-top:20px;">
                                                    <i class="fas fa-times-circle" onclick="remove(this)"></i>
                                                ...
                                                @foreach (languages() as $language)
                                                    <div class="col-md-6 mb-4">
                                                        <label for="validationServer">{{ __('products.value') }}</label>
                                                        <input type="text"
                                                            name="sections[{{ $key }}][value_{{ $language->local }}]"
                                                            class="form-control " id="validationServer"
                                                            placeholder="{{ __('products.value') . ' ' . $language->local }}"
                                                            value="{{ $section->descriptions($language->id)->value }}">
                                                    </div>
                                                @endforeach
                                            </div>
                                        @endforeach
                                ...
                                <div class="col-md-12 mb-4">
                                    <a style="cursor: pointer;" data-id="{{ $count_sections }}"
                                        onclick="addsection(this)" class="btn_1 gray "><i
                                            class="fa fa-fw fa-plus-circle"></i>{{ __('products.addsection') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    @if ($product ?? '' && $product->id)
                                        @foreach ($tags as $key => $tag)
                                            <div class="row pricing-list-item border-item mb-4"
                                                ...
                                                <input type="hidden" name="tags[{{ $key }}][id]"
                                                    value="{{ $tag->id }}">
                                                <div class="col-md-6 mb-4">
                                                    <label for="validationServer">{{ __('products.photo') }}</label>
                                                ...
                                                @foreach (languages() as $language)
                                                    <div class="col-md-6 mb-4">
                                                        <label for="validationServer">{{ __('products.name') }}</label>
                                                        <input type="text"
                                                            name="tags[{{ $key }}][name_{{ $language->local }}]"
                                                            class="form-control " id="validationServer"
                                                            placeholder="{{ __('products.name') . ' ' . $language->local }}"
                                                            value="{{ $tag->descriptions($language->id)->name }}">
                                                    </div>
                                                    <div class="col-md-6 mb-4">
                                                        <label
                                                            for="validationServer">{{ __('products.description') }}</label>
                                                        <input type="text"
                                                            name="tags[{{ $key }}][description_{{ $language->local }}]"
                                                            class="form-control " id="validationServer"
                                                            placeholder="{{ __('products.description') . ' ' . $language->local }}"
                                                            value="{{ $tag->descriptions($language->id)->description }}">
                                                    </div>
                                                @endforeach
                                            </div>
                                        @endforeach
                                ...
                                <div class="col-md-12 mb-4">
                                    <a style="cursor: pointer;" data-id="{{ $count_tags }}" onclick="addtag(this)"
                                        class="btn_1 gray "><i
                                            class="fa fa-fw fa-plus-circle"></i>{{ __('products.addtag') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
