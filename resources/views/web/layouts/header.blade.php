    ...
    <div class="preloader d-flex align-items-center justify-content-center">
        <div class="preloader-inner position-relative">
            <div class="text-center"><img class="mb-10"
                    src="{{ url('') }}/public/assets/web/ASSETS_En/imgs/template/favicon.svg" alt="Furniture Hub">
                ...
                @if (Auth::user())
                    <div class="header-shop">
                        <div class="icons-container" id="icon-header" class="pl-10">                            
                            {{-- header compare icon --}}
                            <a class=" icon-list icon-compare" href="{{ route('compare.index') }}" title="{{ __('web.compare') }}">
                                <span>&nbsp;</span>
                                <svg width="23" height="23" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a class=" icon-list icon-wishlist" href="{{ route('favorite.index') }}" title="{{ __('web.wishlist') }}">
                                    <span>&nbsp;</span>
