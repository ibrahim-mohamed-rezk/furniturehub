                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" name="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" id="validationServer" placeholder="{{__('members.name')}}" value='{{ old("name", $profile->name ?? "") }}'>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <label for="validationServer">{{__('members.email')}}</label>
                                    <input type="email" name="email" class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" id="validationServer" placeholder="{{__('members.email')}}" value='{{ old("email", $profile->email ?? "") }}'>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <label for="validationServer">{{__('members.phone')}}</label>
                                    <input type="number" name="phone" class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" id="validationServer" placeholder="{{__('members.phone')}}" value='{{ old("phone", $profile->phone ?? "") }}'>
                                </div>
                                <div class="col-md-6 mb-4">
                                ...
                                <div class="col-md-6 mb-4">
                                        <img src="{{asset($profile->photo)}}" style="height:10pc">
                                </div>
