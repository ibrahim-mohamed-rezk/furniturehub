{{-- <div id="preloader-active">
    <div class="preloader d-flex align-items-center justify-content-center">
        <div class="preloader-inner position-relative">
            <div class="text-center"><img class="mb-10"
                    src="{{ url('') }}/assets/web/ASSETS_En/imgs/template/favicon.svg" alt="Furniture Hub">
...
{{-- gray dropdown background --}}
{{-- <div class="gray-background"></div> --}}

@if (getCurrentLocale() == 'en')
    <div class="get-app-container" id="installPopup" >
        <div class="logo">
            <img src="{{ asset('storage/icon_pop_up1.svg') }}" alt="FurnitureHub Logo"  />
        </div>
        <div class="content">
            <h2>{{ __('web.furniture_hub_furniture_shopping_made_easy') }}</h2>
            <p>{{ __('web.download_the_app_now_and_get_exclusive_offers') }}</p>
            <div class="rating">
                <div class="stars">
        ...
        <button class="button" id="downloadAppLink"
            onclick="handleDownload('{{ settings('apple') }}', '{{ settings('google') }}')">{{ __('web.download_your_app') }}</button>
...
<div class="topbar" >
    <div class="container-topbar">
        ...
        <div class="menu-topbar-right"><span
                class="font-xs color-brand-3">{{ __('web.need_help_call_us') }}</span><span
            ...
            {{-- <div class="dropdown dropdown-language">
                <button class="btn dropdown-toggle" id="dropdownPage2" type="button" data-bs-toggle="dropdown"
                    aria-expanded="true" data-bs-display="static"><span
                        class="dropdown-right font-xs color-brand-3">{{ $currency->name }}</span></button>
                <ul class="dropdown-menu dropdown-menu-light dropdown-menu-end" aria-labelledby="dropdownPage2"
                    ...
                    @foreach ($currencies as $key => $row)
                        <a href="{{ route('web.change_currency', $row->id) }}"
                            class="dropdown-item @if ($currency->id == $row->id) active @endif">{{ $row->name }}</a>
                    @endforeach
                </ul>
            </div> --}}
            <!-- <div>
                <input type="checkbox" id="darkmode-toggle">
                <label id="dark" for="darkmode-toggle"></label>
            </div> -->
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="main-header">
            ...
            <div class="burger-icon burger-icon-white">
                ...
                <img src="{{ asset('storage/assets/Vector.png') }}" alt="Furniture hub" />
            </div>
            <div class="header-left">
                ...
                @else
                    <div>
                        <a class="nav-login-btn" href="{{ route('web.login') }}">
                            <span> {{ __('web.login') }}</span>
                            <img src="{{ asset('storage/assets/account.svg.png') }}" alt="FurnitureHub">
                        </a>
                    </div>
                @endif
            </div>
    ...
    <div class="mobile-header-wrapper-inner">
        <div class="mobile-header-content-area">
            <div class="mobile-logo">
                @if (getCurrentLocale() == 'en')
                    <a class="d-flex" href="{{ route('web.index') }}">
                        <img alt="Furniture Hub" style="width: 161px" loading="lazy"
                            src="{{ asset(settings('logo')) }}">
                    </a>
                @else
                    <a class="d-flex" href="{{ route('web.index') }}">
                        <img alt="Furniture Hub" style="width: 161px" loading="lazy"
                            src="{{ asset(settings('logo_ar')) }}">
                    </a>
                @endif
            </div>
            <div class="dropdown dropdown-language">
                        ...
                        <ul class="mobile-menu font-heading">
                            @foreach ($categorieshome as $row)
                                <li class="has-children"><span class="menu-expand"><i
                                            class="fi-rr-caret-down"></i></span><a class="active"
                                        href="#">{{ $row->title }}</a>
                                    @if (count($row->models))
                ...
                @if (Auth::user())
                    <div class="mobile-account">
                        ...
                        <ul class="mobile-menu">
                            ...
                            <li><a
                                    href="{{ route('web.quantities') }}">{{ __('web.wholesale_orders_and_quantities') }}</a>
                            </li>


                            <li><a href="tel:{{ settings('phone') }}"
                                    class="text-primary">{{ __('web.call_us') }}</a></li>
