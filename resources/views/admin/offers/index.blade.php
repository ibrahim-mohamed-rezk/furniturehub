                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th>#ID</th>
                                <th scope="col">{{ __('offers.status') }}</th>
                                <th scope="col">{{ __('offers.discount') }}</th>
                                <th scope="col">{{ __('offers.start_date') }}</th>
                                <th scope="col">{{ __('offers.end_date') }}</th>
                                <th class="text-end" scope="col"> {{ __('offers.Action') }}</th>
                            </tr>
                        </thead>
                        <tbody>
