                ...
                <div class="popup-form">
                    ...
                    <form action="{{ route('web.login') }}" method="post" onsubmit="formActionAuth(this)">
                        ...
                        <div class="input-section">
                            ...
                            <div class="inputSec">
                                <input type="password" id="passwordInput" name="password" placeholder="{{__('web.password')}}" />
                                <svg id="showPasswordInput" onclick="showPassword()" width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                ...
                                <svg style="display: none" id="hidePasswordInput" onclick="hidePassword()" width="22" height="21" viewBox="0 0 22 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <div class="no-account">
                            ...
                            <a data-bs-target="#signupModal" data-bs-toggle="modal" style="cursor: pointer">{{__('web.sign_up')}}</a>
                        </div>
                    </form>
                </div>
            </div>
