            ...
            <div class="popup-contaier">
                ...
                <div class="popup-form">
                    ...
                    <form action="{{ route('web.register_check') }}" method="post" onsubmit="formAction(this)">
                        ...
                        <div class="input-section">
                            <label for="name">{{__('web.governorate')}}</label>
                            <div class="inputSec">
                        ...
                        <div class="input-section">
                            ...
                            <div class="inputSec">
                                <input type="password" id="passwordInputSignUp" name="password"
                                    placeholder="{{__('web.password')}}" />
                                <svg id="showPasswordInputSignUp" onclick="showPasswordSignUp()" width="22" height="20"
                                ...
                                <svg style="display: none" id="hidePasswordInputSignUp" onclick="hidePasswordSignUp()"
                        ...
                        <div class="input-section">
                            ...
                            <div class="inputSec">
                                <input type="password" id="passwordInputSignUpConfirm" name="password_confirmation"
                                    placeholder="{{__('web.password_confirmation')}}" />
                                <svg id="showPasswordInputSignUpConfirm" onclick="showPasswordSignUpConfirm()"
                                ...
                                <svg style="display: none" id="hidePasswordInputSignUpConfirm"
                                    onclick="hidePasswordSignUpConfirm()" width="22" height="21" viewBox="0 0 22 21"
